# CiuCiuBot
A customizable Telegram shop bot, developed as a project for #CiùCiùHack Hackaton in OfFida.  
...
## Installation
1. Download the project files through `git clone https://github.com/CyborgTrooper/CiuCiuBot.git` or [this link](https://github.com/CyborgTrooper/CiuCiuBot/archive/master.zip).
...
`CiuCiuBot` currently does not have a documentation page
